...
var callSRC = ["TIGHTS", "STOCKINGS", "SLIPPERS", "SHORTS", "PYJAMAS", "MITTENS", "BOOTS", "AN UMBRELLA", "A SCARF", "A PARKA", "A BAG", "TROUSERS", "SOCKS", "A SKIRT", "SHOES", "A PULLOVER", "LEGGINGS", "A JACKET", "A DRESS", "A CAP"];
var call = [];
var response = [];
var Sounds = { names: [] };
...
$(document).ready(function () {
    $("#version").html("Memory - Clothes v" + VERSION + " &copy 2014 C00lSch00l");
